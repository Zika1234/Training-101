                    ...
                    <form onSubmit={this.handlePassword.bind(this)}>
                        ...
                        <div className="inputs">
                            <div className="email1">
                                ...
                                {this.state.passChecked && <i class="fas fa-check-circle"></i>}
                                {!this.state.passChecked && <i class="fas fa-times-circle"></i>}
                                <div>

                                </div>
                                <input className="second1" type="password" placeholder="Confirm Password" ref="confirmPass" onInput={this.handleInput.bind(this)} />
                                {this.state.passwordMatch && <i class="fas fa-check-circle"></i>}
                                {this.state.passwordNotMatch && <i class="fas fa-times-circle"></i>} <br />
